              ...
              <div className="relative z-10 flex flex-col items-center max-w-xl h-full justify-between">
                ...
                <div className="flex items-center justify-center py-8 relative">
                  ...
                  <motion.img 
                    ...
                    alt="AGP4 Commercial" 
                    className="relative z-10 max-h-[380px] w-auto drop-shadow-[0_45px_50px_rgba(0,0,0,0.8)] cursor-pointer" 
                  />
                </div>
              ...
              <div className="relative z-10 flex flex-col items-center max-w-xl h-full justify-between">
                ...
                <div className="flex items-center justify-center py-8 relative">
                  ...
                  <motion.img 
                    ...
                    alt="AGP4 Home" 
                    className="relative z-10 max-h-[380px] w-auto drop-shadow-[0_40px_50px_rgba(0,0,0,0.2)] cursor-pointer" 
                  />
                </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-16 mb-24">
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-6">
                {['Crop-specific Guides', 'Best Practices', 'Field Results', 'Explore Case Studies', 'AI Farmer Assistant'].map(item => (
                  <li key={item}>
                    <button className="relative group text-left w-full text-sm text-white/50 hover:text-white transition-colors font-body cursor-pointer flex items-center gap-2">
                      {item}
